...
Infrastructure/IaC   ████████████░░░░░░░░  Intermediate
...
|---------|-------|-----------|
| [Lakehouse OLAP Pipelines](https://github.com/zulham-tech/lakehouse-olap-pipelines-flink-clickhouse) | Flink + ClickHouse | 72K events/hr, <2s latency |
| [IoT Streaming Pipeline](https://github.com/zulham-tech/iot-streaming-kafka-pyspark-bigquery) | Kafka + PySpark + BigQuery | Multi-device telemetry |
| [Crypto Lambda Architecture](https://github.com/zulham-tech/crypto-lambda-kafka-cassandra-snowflake) | Kafka + Cassandra + Snowflake | Real-time + batch merge |
| [World Bank ETL](https://github.com/zulham-tech/worldbank-etl-dbt-snowflake-airflow) | dbt + Snowflake + Airflow | 190+ countries, full dbt suite |
| [NYC Taxi Analytics](https://github.com/zulham-tech/nyc-taxi-flink-clickhouse) | Flink + ClickHouse | 3M+ events replayed |
| [Earthquake Monitor](https://github.com/zulham-tech/earthquake-monitor-elasticsearch-kibana) | Elasticsearch + Kibana | Global seismic geospatial |
